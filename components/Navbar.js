                  ...
                  {item.subitems.length === 0 ? (
                    ...
                    <div className="cursor-pointer">
                      <div onClick={() => handleDrop(index)} className="flex justify-between px-5 md:py-3 font-medium items-center space-x-2 hover:text-blue-500">
                        ...
                        { dropClick[index] ? <RiArrowUpSLine size={24} /> : <BiChevronDown size={24} />}
                      </div>
                      ...
                      <ul onClick={() => handleDrop(index)} className={!dropClick[index] ? "opacity-0 h-0 -translate-y-4 overflow-hidden transition md:absolute duration-300 md:shadow-lg md:rounded-b bg-white dark:bg-black" : "bg-white dark:bg-black opacity-1 h-auto  translate-y-0   transition md:absolute  duration-300   md:shadow-lg md:rounded-b "}>
